...
public:
	...
	static void		addFrustum(const glm::vec3& a_position, const glm::vec3& a_lookVector, float a_fov, float a_aspect, float a_near, float a_far, const glm::vec4& a_colour, const glm::mat4* a_transform = nullptr);
